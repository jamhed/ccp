...
**Against vi.spyOn (partial mocks)**:
> "Partial mocks create objects that are partially real, partially mocked, which can be difficult to reason about."

**In favor of vi.spyOn**:
> "SpyOn doesn't hoist, so you avoid weird module resolution errors. Most unit tests don't need the full API."
